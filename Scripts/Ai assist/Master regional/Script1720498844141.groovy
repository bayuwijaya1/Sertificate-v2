...
WebUI.takeScreenshotAsCheckpoint('menampilkan halaman regional')

WebUI.setText(findTestObject('Regional/Text search'), 'Jakarta')

WebUI.click(findTestObject('Regional/Button search'))

WebUI.takeScreenshotAsCheckpoint('menampilkan pencarian')

/*
*  Automate the process of opening a browser, navigating to a specific URL, logging in, and performing actions on a web application.
*
*  1. Open a browser.
...
*  8. Click on a regional button.
*  9. Take a screenshot as a checkpoint for the regional page.
*  10. Set text in the search field with 'Jakarta'.
